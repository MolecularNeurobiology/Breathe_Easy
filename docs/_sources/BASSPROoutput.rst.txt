...
6. another csv file that summarizes the breath selections and calculates averages for each section of the run for both “good breaths” and 
   all other breaths.
    ...
    .. note::
       To help understand some of the variables produced in BASSPRO, you can download :download:`this excel sheet <Docs/BASSPRO_output_descriptions.xlsx>`.
       This resource has units and brief descriptions for the variables generated within BASSPRO.
