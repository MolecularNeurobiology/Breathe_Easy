...
class Ui_Plethysmography(object):
    def setupUi(self, Plethysmography):
        ...
        self.horizontalLayout.addWidget(self.signal_files_button)
        ...
        self.verticalLayout_6.addWidget(self.metadata_button)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.basspro_settings_button.setFont(font)
        self.basspro_settings_button.setObjectName("signal_segments")
        self.verticalLayout_7.addWidget(self.basspro_settings_button)
        ...
        self.verticalLayout_9.addWidget(self.basspro_launch_button)
        ...
        self.stagg_settings_button.clicked.connect(Plethysmography.stagg_settings_config)
    ...
    def retranslateUi(self, Plethysmography):
        ...
        self.metadata_button.setText(_translate("Plethysmography", "Select metadata file"))
