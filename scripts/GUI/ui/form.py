...
class Ui_Plethysmography(object):
    def setupUi(self, Plethysmography):
        ...
        self.bmp_radioButton = QtWidgets.QRadioButton(self.imageformat_group)
        self.bmp_radioButton.setObjectName("bmp_radioButton")
        self.horizontalLayout_10.addWidget(self.bmp_radioButton)
        self.eps_radioButton = QtWidgets.QRadioButton(self.imageformat_group)
        self.eps_radioButton.setObjectName("eps_radioButton")
        self.horizontalLayout_10.addWidget(self.eps_radioButton)
        ...
        self.pdf_radioButton = QtWidgets.QRadioButton(self.imageformat_group)
        self.pdf_radioButton.setObjectName("pdf_radioButton")
        self.horizontalLayout_10.addWidget(self.pdf_radioButton)
        self.png_radioButton = QtWidgets.QRadioButton(self.imageformat_group)
        self.png_radioButton.setObjectName("png_radioButton")
        self.horizontalLayout_10.addWidget(self.png_radioButton)
        self.png_radioButton.setChecked(True)
        self.tiff_radioButton = QtWidgets.QRadioButton(self.imageformat_group)
        self.tiff_radioButton.setObjectName("tiff_radioButton")
        self.horizontalLayout_10.addWidget(self.tiff_radioButton)
...
" input files"))
        ...
        self.bmp_radioButton.setText(_translate("Plethysmography", ".bmp"))
        self.eps_radioButton.setText(_translate("Plethysmography", ".eps"))
        self.jpeg_radioButton.setText(_translate("Plethysmography", ".jpeg"))
        self.pdf_radioButton.setText(_translate("Plethysmography", ".pdf"))
        self.png_radioButton.setText(_translate("Plethysmography", ".png"))
        self.tiff_radioButton.setText(_translate("Plethysmography", ".tiff"))