...
class Ui_Config(object):
    def setupUi(self, Config):
        ...
        self.variable_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        ...
        self.loop_table.setColumnCount(9)
        ...
        self.load_config.clicked.connect(Config.to_check_load_variable_config) # type: ignore
        self.minus_loop_button.clicked.connect(Config.minus_loop) # type: ignore
        self.add_loop_button.clicked.connect(Config.add_loop) # type: ignore
        self.custom_config_button.clicked.connect(Config.show_custom) # type: ignore
        self.clear_config.clicked.connect(Config.reset_config) # type: ignore
        self.cancel_config_button.clicked.connect(Config.close) # type: ignore
        self.cancel_config_button.clicked.connect(Config.reset_config) # type: ignore
        self.save_config_button.clicked.connect(Config.save_config) # type: ignore
        self.saveas_config_button.clicked.connect(Config.saveas_config) # type: ignore
        self.save_config_button.clicked.connect(Config.hide) # type: ignore
        self.saveas_config_button.clicked.connect(Config.hide) # type: ignore
        self.check_cov.clicked.connect(Config.checkable_cov) # type: ignore
        self.check_dep.clicked.connect(Config.checkable_dep) # type: ignore
        self.check_ign.clicked.connect(Config.checkable_ign) # type: ignore
        self.check_ind.clicked.connect(Config.checkable_ind) # type: ignore
    ...
    def retranslateUi(self, Config):
        ...
        item.setText(_translate("Config", "Include filtered breaths:"))
